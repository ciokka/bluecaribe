...
<?php /*		<div class="ovabrw-tab-head">
		...
		<?php if ( $show_booking === 'yes' && $show_request === 'yes' ): ?>
			...
			<?php elseif ( $show_booking === 'yes' && $show_request != 'yes' ): ?>
				<div class="item-content active ovabrw_booking_form" id="modern-booking">
					<?php ovabrw_get_template( 'modern/single/detail/ovabrw-product-booking.php' ); ?><!-- PASSA DI QUI inol3-->
				</div>
			<?php elseif ( $show_booking != 'yes' && $show_request === 'yes' ): ?>
