...
?>
<div class="ovabrw-product-price boxPrezzi">
...
?>
	...
	<?php if ( $min && $max && $min == $max ): ?>
        <span class="unit textPrezzo"><?php esc_html_e('Adult', 'hello-elementor-child'); ?></span>
		<span class="amount prezzo"><?php echo ovabrw_wc_price( $min ); ?></span>
	<?php elseif ( $min && $max ): ?>
		<span class="unit textPrezzo"><?php esc_html_e('Child', 'hello-elementor-child'); ?></span>
		<span class="amount prezzo"><?php echo ovabrw_wc_price( $min ); ?></span>
		<span class="unit textPrezzo">&nbsp;|&nbsp;</span>
        <span class="unit textPrezzo"><?php esc_html_e('Adult', 'hello-elementor-child'); ?></span>
		<span class="amount prezzo"><?php echo ovabrw_wc_price( $max ); ?></span>
	<?php else: ?>
        <span class="amount">
