    ...
    <div class="parent">
        ...
        <div class="div2">
            ...
            <div class="ovabrw-product-short-description" style="display: none;">
                ...
                <button class="read-more-btn"><?php echo icl_t('hello-elementor-child', 'Read more', 'Read more'); ?> <div class="svg-read-more"><svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 16 16' fill='#54AEF2'>
